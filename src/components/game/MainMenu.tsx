...
export const MainMenu: React.FC<MainMenuProps> = ({ onStart }) => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-sky-400 to-indigo-600 flex items-center justify-center p-4">
            <Card className="max-w-4xl w-full border-8 border-yellow-400 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)] bg-white/95 backdrop-blur-md">
                <h1 className="text-6xl sm:text-7xl font-black text-center text-indigo-700 mb-2 tracking-tighter drop-shadow-[0_4px_0_rgba(0,0,0,0.1)]">
                    TEN FRACTIONS
                </h1>
                <p className="text-center text-slate-400 font-black mb-8 text-xl tracking-widest uppercase">
                    🤖 Robots vs Dinosaurs 🦖
                </p>
